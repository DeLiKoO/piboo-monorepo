...
export const bindToCamera = createAction('bindToCamera', withPayloadType<string>());
...
export const onLiveFrameReceived = createAction('onLiveFrameReceived', withPayloadType<Frame>());
